...
namespace Lnk
{
    public class Header
    {
        ...
        {
            return $"C:{CreationDate} M:{ModificationDate} L:{LastAccessedDate}, DataFlags: {DataFlags}, FileAttr:{FileAttributes}, Size: {FileSize:N0}, IconIndex: {IconIndex}, Hotkey: {HotKey}, ShowWindow: {ShowWindow}, Res0: {Reserved0}, Res1: {Reserved1}, Res2: {Reserved2}";
        }
        ...
        public enum DataFlag
        {
            ...
            [Description("The data strings in the LNK file are stored in Unicode (UTF-16 little-endian) instead of ASCII")]
            IsUnicode = 0x00000080,
            [Description("The location information is ignored")]
            ForceNoLinkInfo = 0x00000100,
            [Description("The LNK file contains environment variables location data block")]
            ...
            [Description("The LNK file contains a Darwin (Mac OS-X) properties data block")]
            ...
            [Description("The file system location is represented in the shell namespace when the path to an item is parsed into the link target identifiers")]
            NoPidlAlias0x00008000,
            Reserved1 = 0x00010000,
            [Description("The target application is run with the shim layer. The LNK file contains shim layer properties data block.")]
        ...
        public enum FileAttribute
        {
            ...
            [Description("Is a system file or directory")]
            FILE_ATTRIBUTE_SYSTEM = 0x00000004,
            [Description("Is a volume label/Reserved, not used by the LNK format")]
            RES_VOLUME_LABEL = 0x00000008,
            [Description("Is a directory")]
            FILE_ATTRIBUTE_DIRECTORY = 0x00000010,
            [Description("Should be archived")]
            FILE_ATTRIBUTE_ARCHIVE = 0x00000020,
            [Description("Is a device/Reserved, not used by the LNK format")]
            FILE_ATTRIBUTE_DEVICE = 0x00000040,
            [Description("Is normal (None of the other flags should be set)")]
            FILE_ATTRIBUTE_NORMAL = 0x00000080,
            [Description("Is temporary")]
            FILE_ATTRIBUTE_TEMPORARY = 0x00000100,
            [Description("Is a sparse file")]
            FILE_ATTRIBUTE_SPARSE_FILE = 0x00000200,
            [Description("Is a reparse point or symbolic link")]
            FILE_ATTRIBUTE_REPARSE_POINT = 0x00000400,
            [Description("Is compressed")]
            FILE_ATTRIBUTE_COMPRESSED = 0x00000800,
            [Description("Is offline. The data of the file is stored on an offline storage.")]
            FILE_ATTRIBUTE_OFFLINE = 0x00001000,
            [Description("Do not index content. The content of the file or directory should not be indexed by the indexing service.")]
            FILE_ATTRIBUTE_NOT_CONTENT_INDEXED = 0x00002000,
            [Description("Is encrypted")]
            FILE_ATTRIBUTE_ENCRYPTED = 0x00004000,
            [Description("Unknown (seen on Windows 95 FAT)")]
            UNK_WIN95_FAT = 0x00008000,
        ...
        public enum ShowWindowOption
        {
            ...
            SW_HIDE = 0,
            [Description("Activates and displays the window. The window is restored to its original size and position if the window is minimized or maximized.")]
            SW_NORMAL = 1,
            [Description("Activates and minimizes the window.")]
            SW_SHOWMINIMIZED = 2,
            [Description("Activates and maximizes the window.")]
            SW_MAXIMIZE = 3,
            ...
            SW_MINIMIZE = 6,
            [Description("Display the window as minimized without activating it.")]
            SW_SHOWMINNOACTIVE = 7,
            [Description("Display the window in its current size and position without activating it.")]
            SW_SHOWNA = 8,
            [Description("Activates and displays the window. The window is restored to its original size and position if the window is minimized or maximized.")]
            SW_RESTORE = 9,
            [Description("Set the show state based on the ShowWindow values specified during the creation of the process.")]
            SW_SHOWDEFAULT = 10,
            [Description("Minimizes a window, even if the thread that owns the window is not responding.")]
            SW_FORCEMINIMIZE = 11,
            [Description("Undocumented according to wine project.")]
            SW_NORMALNA = 0xcc
